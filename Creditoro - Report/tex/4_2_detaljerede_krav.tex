...
\myworries{Hvilke brugsmønstre skal med? - kechr}\\


\myworries{Reference links til aktørliste, brugsmønsterbeskrivelse, inceptionsdokument, MosCow - (Hvad betyder det her? - kechr)}
...
\myworries{Fra Henrik: Giv de supplerende krav id'er}