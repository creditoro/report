...
\ifnum \value{PROD}=1
    \includegraphics[scale=0.25]{figures/signatures/signature_kepet19.png}
    \vspace{-8mm}
\fi
\par\rule{\textwidth}{0.4pt}
...
\ifnum \value{PROD}=1
    \includegraphics[scale=0.11]{figures/signatures/Signatur_mara816.png}
    \vspace{-5mm}
\fi
\par\rule{\textwidth}{0.4pt}
...
\begin{tabular}{@{}l l}
Antal sider:    & 48 sider \\ % \pageref{LastPage} virker ikke mere, da der ikke er sidetal på bilag
Bilag:          & 1 bilag 
\end{tabular}
