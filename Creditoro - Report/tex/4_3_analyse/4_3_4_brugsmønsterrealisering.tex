...
\myworries{Generelt set er analysemodellen heller ikke fyldestgørende, da vi ikke viser api'et, desktop-klienten, og epg polleren}

\myworries{Så de systemsekvensdiagrammer indeholder metoder der ikke indgår i vores analysemodel, hvilket også er hvorfor den ikke er blevet opdateret i sektion 7.2.4}

\myworries{Men analysemodellen indeholder ikke api'et, desktop-klienten og epg polleren da vores brugsmønsteranalyse ikke indeholder dem}

\myworries{Og brugsmønsteranalysen indeholder dem ikke fordi vores detaljerede brugsmønstre ikke benævner dem}

\myworries{Hvilket de nok burde :-) - kechr}